      ...
      <article className="mx-auto max-w-5xl px-4 pb-12 pt-6 sm:px-6 sm:pb-16 sm:pt-10 md:pt-14" dir="rtl">
        <header className="mb-16 md:mb-24">
          <div className="relative aspect-[3/4] w-full overflow-hidden bg-neutral-100 sm:aspect-[5/6] md:aspect-[16/9] md:max-h-[min(56vh,560px)]">
            {profile.user.image ? (
              ...
              <img
                ...
                alt=""
                className="h-full w-full object-cover object-center therapist-photo-bw"
              />
            ) : (
              <div className="flex h-full min-h-[280px] items-center justify-center bg-gradient-to-br from-neutral-800 to-neutral-950">
                <span className="font-display text-[clamp(4rem,18vw,8rem)] font-bold text-white/15">
          ...
          <div className="mt-10 md:mt-14">
            ...
            {spec ? (
              <p className="mt-5 max-w-3xl text-lg font-medium leading-snug text-neutral-600 md:text-2xl md:leading-snug">
                {spec}
              </p>
            ) : null}
          </div>
        ...
        <div className="space-y-16 md:space-y-20">
          <section aria-labelledby="bio-heading">
            <p className="text-[11px] font-bold uppercase tracking-[0.38em] text-herbal-700/75">ביוגרפיה</p>
