...
אחרי **Push** ל־`main`, Vercel בונה אוטומטית את **הקומיט העדכני**. אם לחצתם **Redeploy** על דיפלוי ישן, ייתכן שיבנה שוב קומיט ישן — עדיף תמיד **Push** חדש או דיפלוי שמציג את ה־SHA העדכני בראש הלוג.
